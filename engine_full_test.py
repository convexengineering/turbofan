...
from engine_components_test_from_full_ac import FanAndLPC, CombustorCooling, Turbine, ExhaustAndThrust, OnDesignSizing, OffDesign, FanMap, LPCMap, HPCMap
...
class EngineOnDesign(Model):
    ...
    def __init__(self, **kwargs):
        ...
        with SignomialsEnabled():
            ...
            Model.__init__(self, TSFCe, lc, substitutions)
...
##    solOff = engineOffD.localsolve(verbosity = 4, solver="mosek",iteration_limit=200)
    soloff, soloffhold = engineOffD.determine_unbounded_variables(engineOffD, solver="mosek", verbosity=4, iteration_limit=200)
