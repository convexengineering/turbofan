...
def make_figure(topmodel, subsystems, filename, exclude=[]):
    """
    ...
    with open(filename, 'w') as outfile:
        ...
        colours = ['red', 'blue', 'cyan ', 'magenta', 'brown', 'gray', 
                   'olive', 'orange', 'black','red', 'cyan ', 'magenta', 'brown', 'gray','blue',  
                   'olive', 'orange', 'black', 'red', 'blue', 'cyan ', 'magenta', 'brown', 'gray', 
                   'olive', 'orange', 'black']
        for key in viera:
